...
function dynamic_excerpt()
{
  // Variable excerpt length. Length is set in characters
  global $post;
...
function _scripts()
{
  ...
  wp_enqueue_style('scm_template-style', get_stylesheet_uri());
  // Load font awesome css
  wp_enqueue_style('scm_template-font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css');
  // Load minified bundle js
  wp_enqueue_script('scm_template-script', get_template_directory_uri() . '/assets/script/bundle.min.js', array('jquery'), '', true);
  // Load navigation json_decode(json)
  wp_enqueue_script('scm_template-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true);
  // Helps with accessibility for keyboard
  wp_enqueue_script('scm_template-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true);
  // Helps td to judge whether padding needs to be added or not depending on a tag inside of td.
  wp_enqueue_script('scm_template-td-padding', get_template_directory_uri() . '/src/js/td-padding.js', array(), '20120206', true);
