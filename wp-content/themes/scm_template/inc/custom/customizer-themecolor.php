<?php
/**
 * scm_template Theme Color Customizer.
 *
 ...
 *
 * @since SCM Template 1.0
 *
 * @see scm_template_style()
 *
 * @uses scm_template_style()
 * @uses scm_template_admin_header_style()
 * @uses scm_template_admin_header_image()
 */
...
function themename_custom_header_and_background()
{
  ...
  add_theme_support('custom-background', apply_filters('themename_custom_background_args', array(
    ...
    'wp-head-callback'       => 'scm_template_style',
    'admin-preview-callback' => 'scm_template_admin_background_image',
  )));
  ...
  add_theme_support('custom-header', apply_filters('themename_custom_header_args', array(
    ...
    'uploads'                => true,
    'wp-head-callback'       => 'scm_template_style',
    'admin-head-callback'    => 'scm_template_admin_header_style',
    'admin-preview-callback' => 'scm_template_admin_header_image',
  )));
}
