<?php
/**
 * scm_template Theme Customizer.
 *
 * @package scm_template
 */

if (!function_exists('scm_template_style')) :
  /**
   * Styles the header image and text displayed on the blog
   *
   * @see scm_template_custom_header_setup().
   */
  function scm_template_style()
  {
    // Theme color
...
endif; // scm_template_style

if (!function_exists('scm_template_admin_header_style')) :
/**
 * Styles the header image displayed on the Appearance > Header admin panel.
 *
 * @see scm_template_custom_header_setup().
 */
  function scm_template_admin_header_style()
  { ?>
    <style type="text/css">
...
endif; // scm_template_admin_header_style

if (!function_exists('scm_template_admin_header_image')) :
  /**
   * Custom header image markup displayed on the Appearance > Header admin panel.
   *
   * @see scm_template_custom_header_setup().
   */
  function scm_template_admin_header_image()
  { ?>
    <div id="headimg">
...
endif; // scm_template_admin_header_image
 ...
 */
function scm_template_customize_preview_js()
{
  wp_enqueue_script('scm_template_customizer', get_template_directory_uri() . '/js/customizer.js', array('customize-preview'), '20130508', true);
}
add_action('customize_preview_init', 'scm_template_customize_preview_js');
?>
