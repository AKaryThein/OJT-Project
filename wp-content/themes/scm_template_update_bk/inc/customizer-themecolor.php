...
function header_footer_color_customizer($wp_customize)
{
  ...
  $wp_customize->add_control(new Customize_Alpha_Color_Control($wp_customize, 'header_bgcolor', array(
  ...
  $wp_customize->add_control(new Customize_Alpha_Color_Control($wp_customize, 'footer_bgcolor', array(
  ...
  $wp_customize->add_control(new Customize_Alpha_Color_Control($wp_customize, 'txtcolor', array(
    'label'    => 'Text Color',
    'section'  => 'colors',
    'settings' => 'txtcolor',
    'show_opacity'  => true, 
